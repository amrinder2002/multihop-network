...
filename = 'the matrix has you.png'
...
# message = open(parent_dir + f"/{filename}", "rb").read()
# input message from file
message = open(os.path.join(parent_dir, filename), 'rb').read()

# (What kind of name will be given to message using which it will be delivered at
# the recipient side).
message_name = "LOREM IPSUM"
